...
const dict = {
  en: {
    ...
    heroDescription: "We bring builders, analysts, and creatives together to shape the future of sport with AI. Hands-on projects. Thoughtful experimentation. Real outcomes—crafted by students.",
  ...
  pl: {
    ...
    heroDescription: "Łączymy inżynierów, analityków i twórców, aby wspólnie kształtować przyszłość sportu dzięki sztucznej inteligencji. Praktyczne projekty. Przemyślane eksperymenty. Rzeczywiste wyniki — tworzone przez studentów.",
